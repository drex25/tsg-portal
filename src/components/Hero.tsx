      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-[#0056A6]">innovación</span> en organizaciones públicas y privadas
              </h1>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#0056A6]">+200</div>
                <div className="text-sm text-gray-600">Profesionales</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#0056A6]">7</div>
                <div className="text-sm text-gray-600">Provincias</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#0056A6]">360°</div>
                <div className="text-sm text-gray-600">Visión integral</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-6">
                  <Users className="h-8 w-8 mb-4 text-[#0056A6]" />
                  <h3 className="font-semibold mb-2 text-gray-800">Equipo</h3>
                  <p className="text-sm text-gray-600">+200 expertos</p>
                </div>
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-6">
                  <Zap className="h-8 w-8 mb-4 text-[#0056A6]" />
                  <h3 className="font-semibold mb-2 text-gray-800">Innovación</h3>
                  <p className="text-sm text-gray-600">Tecnología de punta</p>
                </div>
                <div className="bg-gradient-to-br from-[#0056A6] to-[#004494] rounded-xl p-6 text-white">
            ...
            <div className="absolute -top-4 -right-4 w-72 h-72 bg-[#0056A6]/10 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-gray-200 rounded-full blur-3xl"></div>
          </div>
        </div>
      </div>
    </section>
